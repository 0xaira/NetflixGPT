...
const VideoTitle = ({ title, overview }) => {
  ...
  return (
    ...
    <div className="w-screen aspect-video pt-96 px-12 absolute text-white">
      <h1 className='text-4xl md:text-5xl lg:text-6xl mb-2 line-clamp-2 font-bold'>{title}</h1>
      <p className='text-sm md:text-base line-clamp-2 md:line-clamp-2 xl:line-clamp-3 w-[650px]'>{truncatedOverview}</p>
